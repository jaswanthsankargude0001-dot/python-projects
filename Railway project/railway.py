...
class Train:
    def __init__(self, train_num, source, destination, seats):
        ...
        self.seats = seats
#     We define the Train class, which takes in four parameter a train number, source, destination, and number of available seats. The _init_() method is called when a new Train object is created and initializes these attributes.
    def display_info(self):
        ...
        print()
 # line break for each train information is displayed
